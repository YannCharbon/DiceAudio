...
namespace DiceAudio
{
    public class DAScenarioItem
    {
        ...
        /// <see cref="ItemType.Scene"/>. Embedded (self-contained) so scenario
        /// groups and presets carry their scenes with them; the scene catalogue
        /// holds independent reusable copies.
        /// </summary>
